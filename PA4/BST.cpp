...
template <typename Comparable>
void searchBST(Node<Comparable>* root, string str,bool &isFound) {
	...
	if (root != nullptr) {
		...
		if (doesIncludeBST(str, string(root->data))) {
			...
			searchBST(root->left, str,isFound);


			searchBST(root->right, str,isFound);
		}
...
template <typename Comparable>
void searchBSTwithoutPrint(Node<Comparable>* root, string str) {
	...
	if (root != nullptr) {
		...
		if (doesIncludeBST(str, string(root->data))) {
			...
			//if we find a matching pair then the rest of matching contacts
			//will be in the subtrees of the first found contact
			searchBSTwithoutPrint(root->left, str);


			searchBSTwithoutPrint(root->right, str);
		}
...
template <typename Comparable>
bool BST<Comparable>::SearchAContact(string str) {
	bool isFound = false;

	searchBST(root, str,isFound);
	return isFound;

}

template<typename Comparable>
void BST<Comparable>::SearchAContactWithoutPrint(string str)
{
	searchBSTwithoutPrint(root, str);
}
